...
- 投稿削除・削除して再編集
- 引用投稿の表示・作成
- Misskey リアクション（絵文字ピッカー付き）・Misskey Play・クリップ
- ハッシュタグフォロー・ハッシュタグタイムライン
...
- [**v1.11**](https://github.com/pooza/capsicum/milestone/15) — 大型機能 + Misskey 固有（NowPlaying・通知統合一覧・ドライブ管理・下書き・ページ・実績・ポイピク連携）
- [**v1.10**](https://github.com/pooza/capsicum/milestone/14) — メディア周り + モロヘイヤ連携 + UX（メディアカタログ・メディア API v2・ALT 編集・サムネイルサイズ・アンテナ・投稿プレビュー・DM タイムライン 等）
- [**v1.9**](https://github.com/pooza/capsicum/milestone/13) — 設定画面整理 + 表示カスタマイズ + モロヘイヤ連携（設定画面構造整理・notestock 検索修正・絶対時間表示・画像/OGP ぼかし・投稿前確認・リスト/タグTL 表示管理 等）
