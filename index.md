...
**v1.15.0**（2026-04-15）App Store / Google Play 両ストア公開済み

## ロードマップ

- [**v1.16**](https://github.com/pooza/capsicum/milestone/20) — Misskey 拡充 + MFM + API 改善（Misskey ページ機能・メッセージ機能・isCat・Mastodon MFM 部分レンダリング・メディア API v2）
- [**v1.17**](https://github.com/pooza/capsicum/milestone/21) — 通知・お知らせのタブ化を中心とした UI 再整理
- **v1.18（仮）** — プッシュ通知リレーの実装。プリセットサーバーのユーザー向けに Mastodon Web Push リレーの提供を開始する予定。着手時期は v1.15 の観測結果を踏まえて確定
