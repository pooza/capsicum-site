...
**v1.46.0**（2026-07-11） Android（Google Play）・macOS Mac App Store・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p)・Linux AppImage で公開済みです（iOS App Store は審査中）。
