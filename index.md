...
**v1.48.0**（2026-07-16） Android（Google Play）・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p)・Linux AppImage で公開済みです。iOS App Store・macOS Mac App Store は現在審査中です。
