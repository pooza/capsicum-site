...
- [**v1.12**](https://github.com/pooza/capsicum/milestone/16) — Misskey 固有機能 + 繰り越し分（isCat・実績・ページ・下書き・メッセージ・DM タイムライン・通知統合一覧・ポイピク連携・メディア API v2）
- [**v1.11**](https://github.com/pooza/capsicum/milestone/15) — 機能拡充 + モロヘイヤ連携（NowPlaying 投稿・ナウプレ削除・メディアカタログ・ドライブ管理・アンテナ・投稿プレビュー・URL コピー・タイムラインタブ切替・ステータスページリンク）
