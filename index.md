...
- [**v1.6**](https://github.com/pooza/capsicum/milestone/9) — タイムライン拡張・モロヘイヤ連携
- [**v1.5**](https://github.com/pooza/capsicum/milestone/7) — プロフィール・メディア強化
- [**v1.4**](https://github.com/pooza/capsicum/milestone/6) — テスター要望
- [**v1.3**](https://github.com/pooza/capsicum/milestone/5) — 引用操作・ピン留め・インスタンスティッカー・お気に入りユーザー表示・バグ修正 等
