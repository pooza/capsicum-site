...
- [**v1.8**](https://github.com/pooza/capsicum/milestone/12) — UX 改善・Misskey 固有機能（公開範囲デフォルト・isCat・アンテナ・サーバー情報画面 等）
- [**v1.7**](https://github.com/pooza/capsicum/milestone/10) — 追加機能（通知統合一覧・Misskey ドライブ・メディアカタログ・アンケート作成・DM タイムライン 等）
- [**v1.6**](https://github.com/pooza/capsicum/milestone/9) — ユーザー要望の継続消化（翻訳・ハッシュタグフォロー・Misskey Play・予約投稿タグ編集 等）
