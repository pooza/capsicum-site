...
**v1.36.1**（2026-06-13） Android（Google Play）・macOS Mac App Store・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p)・Linux AppImage で公開済み、iOS App Store は順次公開中
