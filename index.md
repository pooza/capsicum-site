...
**v1.13.0**（2026-04-09）AppStore 審査通過済み

## ロードマップ

- [**v1.16**](https://github.com/pooza/capsicum/milestone/20) — Misskey 機能拡充（ページ機能・メッセージ機能）
- [**v1.15**](https://github.com/pooza/capsicum/milestone/19) — 連携 + 絵文字強化 + MFM（ポイピク連携・メディア API v2・isCat 対応・最近使った絵文字・Unicode 絵文字拡充・背景画像サーバー別・Mastodon MFM 部分レンダリング）
- [**v1.14**](https://github.com/pooza/capsicum/milestone/18) — 通知統合 + UX 改善（通知・お知らせ統合一覧・通知タブ化・iOS通知バグ修正・投稿内容消失修正・TLジャンプ修正・ブースト公開範囲指定・実況フィルタボット判定・ログイン調査）
