...
- [**v1.5**](https://github.com/pooza/capsicum/milestone/7) — タブカスタマイズ・テーマ設定
- [**v1.4**](https://github.com/pooza/capsicum/milestone/6) — テスター要望・追加機能
- [**v1.3**](https://github.com/pooza/capsicum/milestone/5) — 入力補完・引用操作・お気に入りユーザー表示 等
- [**v1.2**](https://github.com/pooza/capsicum/milestone/4) — Misskey 固有機能の拡充 + モロヘイヤ WebUI 連携
- [**v1.1**](https://github.com/pooza/capsicum/milestone/3) — ユーザー体験の向上（プロフィール編集・リスト管理・マーカー API 等）
