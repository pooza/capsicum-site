...
**v1.17.0**（2026-04-18）App Store / Google Play 両ストア公開済み

## ロードマップ

- [**v1.18**](https://github.com/pooza/capsicum/milestone/22) — プッシュ通知リレー（Web Push → APNs / FCM）の実装
- [**v1.19**](https://github.com/pooza/capsicum/milestone/23) — macOS ネイティブビルド化（デスクトップ対応 第1段階）
- [**v1.20**](https://github.com/pooza/capsicum/milestone/24) — 通知モデル再設計 + 抽象化層（デスクトップ対応 第2段階）
- [**v1.21**](https://github.com/pooza/capsicum/milestone/25) — Linux / Windows 対応（デスクトップ対応 第3段階）

v1.18 でプッシュ通知対応を完了した後、v1.19 以降はデスクトップ環境への段階的な展開が主軸になります。iOS 版を Mac 上で実況用途に使い手応えを得たことが動機です。macOS ネイティブ化からスタートし、通知モデルの再設計を経て、Linux / Windows に広げていきます。
