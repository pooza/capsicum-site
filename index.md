...
**v1.35.0**（2026-06-09） Android（Google Play）・iOS App Store・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p)・Linux AppImage は公開済み、macOS Mac App Store は審査中
