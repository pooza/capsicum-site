...
**v1.33.0**（2026-06-06） Linux AppImage・Windows MSIX 自己署名直配・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p) は公開済み、Android（Google Play）は製品版に提出済み（公開間近）、iOS App Store・macOS Mac App Store は審査提出済み
