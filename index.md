...
**v1.40.0**（2026-06-24） Android（Google Play）・iOS App Store・[Windows Microsoft Store](https://apps.microsoft.com/detail/9np2gr7m2w6p)・Linux AppImage で公開済みです（macOS Mac App Store は審査中）
