...
- [**v1.15**](https://github.com/pooza/capsicum/milestone/19) — 連携 + Misskey 猫化
- [**v1.14**](https://github.com/pooza/capsicum/milestone/18) — 通知統合 + 下書き + ユーザーフィードバック対応
- [**v1.13**](https://github.com/pooza/capsicum/milestone/17) — DM・メッセージ + UI 改善 + バグ修正
